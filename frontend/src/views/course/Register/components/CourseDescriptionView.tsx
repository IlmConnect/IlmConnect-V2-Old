...
const CourseDescriptionView :React.FC<Props> = ({courseId}) => {
	...
	return (
		...
		>
			...
			<HtmlEditor value={showCourseDescription(location.state.description)} disabled={true} hideAllBars={true}></HtmlEditor>
		</Box>
	);
  };
